...
1. Написать программу на С с использованием ассемблерной вставки (GCC Inline Assembly) из нескольких строк. Сгенерировать листинг программы и узнать, как вставка выглядит в листинге. 
2. Получить в листинге (написав соответствующий код на С) **метки** и дополнить ими ассемблерную вставку.
...
12. Вывод текущего элемента на каждой итерации при поиске максимального элемента в массиве (придется поработать с ситуацией разрыва ассемблерной вставки, когда последняя разбивается на две, а между ними пишется код на С).
13. Написать алгоритм сортировки массива за O(N<sup>2</sup>) (вложенные циклы).
14. Адаптировать код сортировки для использования в профайлере -- файле, который лежит в папке bubble\_profiler. 
...
15. Модифицировать алгоритм сортировки для ускорения работы (**любыми** способами). Три лучшие по скорости сортировки получат за лабу два плюса, а не один. Отправить сортировку необходимо до 29.09. 16:59.
